...
public class ItemMappingData {
    ...
    static Map<String, Integer> signsEntryItemMapping = new HashMap<>() {{
        put("blocks/canvas_sign", 5);
        put("blocks/white_canvas_sign", 7);
        put("blocks/red_canvas_sign", 7);
        put("blocks/blue_canvas_sign", 7);
        put("blocks/yellow_canvas_sign", 7);
        put("blocks/orange_canvas_sign", 7);
        put("blocks/brown_canvas_sign", 7);
        put("blocks/magenta_canvas_sign", 7);
        put("blocks/pink_canvas_sign", 7);
        put("blocks/purple_canvas_sign", 7);
        put("blocks/black_canvas_sign", 7);
        put("blocks/cyan_canvas_sign", 7);
        put("blocks/gray_canvas_sign", 7);
        put("blocks/light_gray_canvas_sign", 7);
        put("blocks/lime_canvas_sign", 7);
        put("blocks/light_blue_canvas_sign", 7);
        put("blocks/green_canvas_sign", 7);
    }};

    static Map<String, Integer> hangingSignsEntryItemMapping = new HashMap<>() {{
        put("blocks/hanging_canvas_sign", 6);
        put("blocks/white_hanging_canvas_sign", 8);
        put("blocks/red_hanging_canvas_sign", 8);
        put("blocks/blue_hanging_canvas_sign", 8);
        put("blocks/yellow_hanging_canvas_sign", 8);
        put("blocks/orange_hanging_canvas_sign", 8);
        put("blocks/brown_hanging_canvas_sign", 8);
        put("blocks/magenta_hanging_canvas_sign", 8);
        put("blocks/pink_hanging_canvas_sign", 8);
        put("blocks/purple_hanging_canvas_sign", 8);
        put("blocks/black_hanging_canvas_sign", 8);
        put("blocks/cyan_hanging_canvas_sign", 8);
        put("blocks/gray_hanging_canvas_sign", 8);
        put("blocks/light_gray_hanging_canvas_sign", 8);
        put("blocks/lime_hanging_canvas_sign", 8);
        put("blocks/light_blue_hanging_canvas_sign", 8);
        put("blocks/green_hanging_canvas_sign", 8);
    }};
    ...
    static Map<Map<String, Integer>, ResourceLocation> allMapping = new HashMap<>() {
        {
            ...
            put(hangingSignsEntryItemMapping, make("basics/straw"));
